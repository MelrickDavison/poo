...
let alune1 = new Aluno('Kemylly', "333.333.333-54", '15/07/2006', '321');
let alune2 = new Aluno('Melrick', "444.444.444-44", '04/09/2006', '123');
let alune3 = new Aluno('Gabriel', '555.555.555-55', '20/04/2006', '231');
